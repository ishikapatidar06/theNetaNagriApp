...
function Navbar() {
  ...
  return (
    <>
      <div className="flex w-full h-16 fixed z-10 bg-[#7f2e50] justify-between items-center p-2 md:px-8  py-2">
        <div className="h-full flex pl-2">
          <Link to="/">
            <img src={logo} alt="logo" className="h-full flex-shrink-0 " />
          </Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden fixed top-16 right-0 w-1/2 bg-white/90 ... z-10 flex flex-col items-center space-y-6 py-8">
